...
#from retail_banking import oppty_account_cleanup
from retail_banking import oppty_account_gen
# from retail_banking import oppty_case_gen
# from retail_banking import oppty_contact_gen
# from retail_banking import oppty_event_gen
# from retail_banking import oppty_history_gen
from retail_banking import oppty_gen
# from retail_banking import oppty_lead_gen
# from retail_banking import oppty_line_item_gen
# from retail_banking import oppty_product_gen
# from retail_banking import oppty_forecasting_quota_gen
# from retail_banking import oppty_forecasting_user_gen
# from retail_banking import oppty_quota_gen
from retail_banking import oppty_shape_gen
# from retail_banking import oppty_task_gen
# from retail_banking import oppty_user_gen
...
def run():
    ...
    if 1==2: # -oktana
        ...
        oppty_shape_gen.run(batch_id, oppty_shape_file, oppty_file, today_datetime,
                            lambda cv: dateutil.parser.parse(cv['CreatedDate']) >= cutoff_date)

    # generate accounts
    account_file = output_path + 'Account.csv'
    oppty_account_gen.run(batch_id, definitions.source_account, account_file)
