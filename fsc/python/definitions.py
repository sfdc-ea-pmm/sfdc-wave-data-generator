...
# source_data = 'retail_banking/data/input/WA_Fn-UseC_-Sales-Win-Loss.csv'
# source_users = 'retail_banking/data/input/Users.csv'
source_oppty_shape = 'retail_banking/data/input/SourceOpportunities.csv'
source_oppty_shape = 'retail_banking/data/input/SourceOpportunities.csv'
source_account = 'retail_banking/data/input/SourceAccounts.csv'

oppty_temporal_path = 'retail_banking/data/output/archive/{}/'
oppty_latest_path = 'retail_banking/data/output/latest/'

oppty_shape = 'retail_banking/data/output/OpportunityShape.csv'
oppty = 'retail_banking/data/output/Opportunity.csv'


# oppty_accounts = 'retail_banking/data/output/Account.csv'
# oppty_accounts_test = 'retail_banking/data/output/Account Test.csv'
# oppty_users = 'retail_banking/data/output/User.csv'
# oppty_managers = 'retail_banking/data/output/Manager.csv'
# oppty_products = 'retail_banking/data/output/Product2.csv'
# oppty_pricebook = 'retail_banking/data/output/PricebookEntry.csv'
# oppty_line_item = 'retail_banking/data/output/OpportunityLineItem.csv'
# oppty_history = 'retail_banking/data/output/OpportunityHistory.csv'
# oppty_cases = 'retail_banking/data/output/Case.csv'
# oppty_tasks = 'retail_banking/data/output/Task.csv'
# oppty_events = 'retail_banking/data/output/Event.csv'
# oppty_leads = 'retail_banking/data/output/Lead.csv'
# oppty_contacts = 'retail_banking/data/output/Contact.csv'
# oppty_forecasting_quota = 'retail_banking/data/output/ForecastingQuota.csv'
# oppty_forecasting_user = 'retail_banking/data/output/ForecastingUser.csv'
# oppty_quota = 'retail_banking/data/output/Quota.csv'
