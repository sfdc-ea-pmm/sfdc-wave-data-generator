...
from fsc_wealth_cumulus import fsc_wealth_cumulus_generator

def run():
    today = date.today()
    config_path = 'fsc_wealth_cumulus/config.json'

    if os.environ.get('WRITE_MODE') != 'S3':
        source_path = 'fsc_wealth_cumulus/data/input/'
        output_path = 'fsc_wealth_cumulus/data/output/latest/'
        archive_path = 'fsc_wealth_cumulus/data/output/archive/{}/'.format(today.isoformat())
    else:
        source_path = 'fsc-wealth-cumulus/data/input/'
        output_path = 'fsc-wealth-cumulus/data/output/latest/'
        archive_path = 'fsc-wealth-cumulus/data/output/archive/{}/'.format(today.isoformat())
